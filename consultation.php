...
<body>
	...
	<form action="consultation.php" method = "POST">
        ...
        <div class="input-box">
                        ...
                        <input type="date" name="CDate" placeholder="The date today" required><script>let today = new Date().toISOString().subtr(0,10);
        document.querySelector("#datepicker").value = today;</script>
                    </div>
